...
type OrderUseCase struct {
	...
	RepoTransactionID Repository.ITransactionIDRepo
}
...
func NewOrderUseCase(Repo Repository.IOrderRepo, RepoStock Repository.IStockRepo, RepoTransactionID Repository.ITransactionIDRepo) IOrderUseCase {
