...
func NewTransactionIDUseCase(repo Repository.ITransactionIDRepo, repoProduct Repository.IProductRepo, repoAddress Repository.IAddressRepo) ITransactionIDUseCase {
