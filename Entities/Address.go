...
func ValidateCity(rawData map[string]interface{}) error {
...
func ValidateCountry(rawData map[string]interface{}) error {
...
func ValidateAPrice(rawData map[string]interface{}) error {
